...
DEMO_OPTS="${INSTALL_OPTS} --set global.defaultPodDisruptionBudget.enabled=false"
...
run-build-kustom:
	bin/iop ${ISTIO_INGRESS_NS} istio-ingress ${BASE}/gateways/istio-ingress -t  ${INSTALL_OPTS} > ${BASE}/kustomize/istio-ingress/istio-ingress.yaml
	bin/iop ${ISTIO_SYSTEM_NS} istio-system-security ${BASE}/security/citadel -t --set kustomize=true  ${INSTALL_OPTS} > ${BASE}/kustomize/citadel/citadel.yaml
...
install-base: install-crds
	...
	bin/iop ${ISTIO_SYSTEM_NS} istio-system-security ${BASE}/security/citadel ${INSTALL_OPTS}
	...
	bin/iop ${ISTIO_CONTROL_NS} istio-config ${BASE}/istio-control/istio-config ${INSTALL_OPTS}
	bin/iop ${ISTIO_CONTROL_NS} istio-discovery ${BASE}/istio-control/istio-discovery  ${INSTALL_OPTS}
...
install-ingress:
	...
	bin/iop ${ISTIO_INGRESS_NS} istio-ingress ${BASE}/gateways/istio-ingress ${INSTALL_OPTS}
...
install-egress:
	...
	bin/iop ${ISTIO_EGRESS_NS} istio-egress ${BASE}/gateways/istio-egress ${INSTALL_OPTS}
...
install-telemetry:
	...
	bin/iop ${ISTIO_TELEMETRY_NS} istio-prometheus ${BASE}/istio-telemetry/prometheus/ ${INSTALL_OPTS}
	bin/iop ${ISTIO_TELEMETRY_NS} istio-mixer ${BASE}/istio-telemetry/mixer-telemetry/ ${INSTALL_OPTS}
...
install-policy:
	...
	bin/iop ${ISTIO_POLICY_NS} istio-policy ${BASE}/istio-policy ${INSTALL_OPTS}
...
install-prometheus-operator-config:
	...
	bin/iop ${ISTIO_CONTROL_NS} istio-prometheus-operator ${BASE}/istio-telemetry/prometheus-operator/ -t ${PROM_OPTS} ${INSTALL_OPTS} | kubectl apply -n ${ISTIO_CONTROL_NS} -f -
